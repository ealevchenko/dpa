<%@ Page Title="" Language="C#" MasterPageFile="~/WebSite/Strategic/Strategic.master" AutoEventWireup="true" CodeFile="ScalesProgram.aspx.cs" Inherits="WebSite_Strategic_ScalesProgram"  MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:MultiView ID="mvStatus" runat="server">
        <asp:View ID="vList" runat="server">
            <wuc:controlProgramProject ID="controlProgramProject" runat="server" Change="false" OutInfoText="true" IDImplementationProgram="1" OnDateSelect="controlProgramProject_DateSelect" />
        </asp:View>
