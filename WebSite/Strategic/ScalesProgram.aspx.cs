...
public partial class WebSite_Strategic_ScalesProgram : BaseStrategicPages
{
    /// <summary>
    /// Загрузка страницы
    /// </summary>
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ((StrategicMaster)Master).SetHeader(base.GetStringBaseResource("titleMenuProject"), base.GetStringStrategicResource("menuScalesProgram"));
