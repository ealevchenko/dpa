...
public partial class controlTypeProject : BaseControlUpdateFormView
{
    ...
    protected int? idtypeproject { get { return this.IDTypeProject != null ? this.IDTypeProject : null; } }

    protected bool outinfo { get { return this.OutInfoText != null ? this.OutInfoText : false; } }

    protected string save_typeproject { get { return base.fmc.GetTextTextBox(fvTable, "tbTypeProject"); } }
    protected string save_typeprojecteng { get { return base.fmc.GetTextTextBox(fvTable, "tbTypeProjectEng"); } }
    ...
    {
        e.InputParameters["IDTypeProject"] = this.idtypeproject;
    ...
    {
        e.InputParameters["TypeProject"] = this.save_typeproject;
        e.InputParameters["TypeProjectEng"] = this.save_typeprojecteng;
